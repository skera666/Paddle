  ...
  if (WITH_GPU)
    ...
    if(nv_library_SRCS)
      ...
      if (nv_library_DEPS)
        ...
        if (${TARGET_NAME} STREQUAL "transformer_op")
          #target_link_libraries(${TARGET_NAME} ${nv_library_DEPS} "-lcublas;-lcudart")
          target_link_libraries(${TARGET_NAME} ${nv_library_DEPS} "-lcublas")
        else()
